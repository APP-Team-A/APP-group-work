      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Building Tomorrow&apos;s<br className="hidden sm:inline" />Technology Today
            </h1>
            ...
            >
              We&apos;re a diverse team of engineers, designers, and innovators creating cutting-edge solutions that shape the future of technology.
            </p>
